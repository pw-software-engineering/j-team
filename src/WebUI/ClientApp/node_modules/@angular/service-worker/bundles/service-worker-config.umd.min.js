 ...
 * License: MIT
 */
!function(e,r){"object"==typeof exports&&"undefined"!=typeof module?r(exports):"function"==typeof define&&define.amd?define("@angular/service-worker/config",["exports"],r):r(((e=e||self).ng=e.ng||{},e.ng.serviceWorker=e.ng.serviceWorker||{},e.ng.serviceWorker.config={}))}(this,(function(e){"use strict";
/*! *****************************************************************************
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */var u=[{replace:/\./g,with:"\\."},{replace:/\+/g,with:"\\+"},{replace:/\*/g,with:"[^/]*"}],c=o(u,[{replace:/\?/g,with:"[^/]"}]),f=o(u,[{replace:/\?/g,with:"\\?"}]);function l(e,r){void 0===r&&(r=!1);for(var t=r?f:c,n=e.split("/").reverse(),o="";n.length>0;){var i=n.pop();"**"===i?o+=n.length>0?"(?:.+\\/)?":".*":(o+=t.reduce((function(e,r){return e.replace(r.replace,r.with)}),i),n.length>0&&(o+="\\/"))}return o}var p=["/**","!/**/*.*","!/**/*__*","!/**/*__*/**"],h=function(){function e(e,r){this.fs=e,this.baseHref=r}return e.prototype.process=function(e){var n;return r(this,void 0,void 0,(function(){var r,o;return t(this,(function(t){switch(t.label){case 0:return[4,this.processAssetGroups(e,r={})];case 1:return o=t.sent(),[2,{configVersion:1,timestamp:Date.now(),appData:e.appData,index:d(this.baseHref,e.index),assetGroups:o,dataGroups:this.processDataGroups(e),hashTable:(a=r,u={},Object.keys(a).sort().forEach((function(e){return u[e]=a[e]})),u),navigationUrls:(i=this.baseHref,s=e.navigationUrls,void 0===s&&(s=p),s.map((function(e){var r=!e.startsWith("!");return{positive:r,regex:"^"+v(e=r?e:e.substr(1),i)+"$"}}))),navigationRequestStrategy:null!==(n=e.navigationRequestStrategy)&&void 0!==n?n:"performance"}]}var i,s,a,u}))}))},e.prototype.processAssetGroups=function(e,n){return r(this,void 0,void 0,(function(){var o,i=this;return t(this,(function(s){return o=new Set,[2,Promise.all((e.assetGroups||[]).map((function(e){return r(i,void 0,void 0,(function(){var i,s,a,u=this;return t(this,(function(c){switch(c.label){case 0:if(e.resources.versionedFiles)throw new Error("Asset-group '"+e.name+"' in 'ngsw-config.json' uses the 'versionedFiles' option, which is no longer supported. Use 'files' instead.");return i=function f(e){var r=e.map((function(e){return e.startsWith("!")?{positive:!1,regex:new RegExp("^"+l(e.substr(1))+"$")}:{positive:!0,regex:new RegExp("^"+l(e)+"$")}}));return function(e){return function t(e,r){return r.reduce((function(r,t){return t.positive?r||t.regex.test(e):r&&!t.regex.test(e)}),!1)}(e,r)}}(e.resources.files||[]),[4,this.fs.list("/")];case 1:return s=c.sent(),(a=s.filter(i).filter((function(e){return!o.has(e)})).sort()).forEach((function(e){return o.add(e)})),[4,a.reduce((function(e,o){return r(u,void 0,void 0,(function(){var r;return t(this,(function(t){switch(t.label){case 0:return[4,e];case 1:return t.sent(),[4,this.fs.hash(o)];case 2:return r=t.sent(),n[d(this.baseHref,o)]=r,[2]}}))}))}),Promise.resolve())];case 2:return c.sent(),[2,{name:e.name,installMode:e.installMode||"prefetch",updateMode:e.updateMode||e.installMode||"prefetch",cacheQueryOptions:g(e.cacheQueryOptions),urls:a.map((function(e){return d(u.baseHref,e)})),patterns:(e.resources.urls||[]).map((function(e){return v(e,u.baseHref,!0)}))}]}}))}))})))]}))}))},e.prototype.processDataGroups=function(e){var r=this;return(e.dataGroups||[]).map((function(e){return{name:e.name,patterns:e.urls.map((function(e){return v(e,r.baseHref,!0)})),strategy:e.cacheConfig.strategy||"performance",maxSize:e.cacheConfig.maxSize,maxAge:a(e.cacheConfig.maxAge),timeoutMs:e.cacheConfig.timeout&&a(e.cacheConfig.timeout),cacheQueryOptions:g(e.cacheQueryOptions),version:void 0!==e.version?e.version:1}}))},e}();function v(e,r,t){return e.startsWith("/")||-1!==e.indexOf("://")||(e=d(r.replace(/^\.(?=\/)/,""),e)),l(e,t)}function d(e,r){return e.endsWith("/")&&r.startsWith("/")?e+r.substr(1):e.endsWith("/")||r.startsWith("/")?e+r:e+"/"+r}function g(e){return Object.assign({ignoreVary:!0},e)}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
